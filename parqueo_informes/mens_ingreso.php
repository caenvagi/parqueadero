...
$sql = "SELECT
        ...
        WHERE DATE(mh.fecha_ingreso) BETWEEN :fecha_inicio AND :fecha_fin
        ORDER BY mh.fecha_ingreso DESC, mh.id DESC";
            ...
            <div class="container mt-4">
                <div class="card shadow">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Mensualidades ingresadas</h5>
                    ...
                    <div class="card-body">
                        <form method="GET" class="row g-3 align-items-end mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <a href="mens_ingreso.php" class="btn btn-secondary">Mes actual</a>
                            </div>
                        </form>

                        <div class="table-responsive">
                            <table class="table table-hover table-bordered align-middle nowrap" id="tablaIngresos" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Ingreso</th>
                                        <th>Retiro</th>
                                ...
                                <tbody>
                                    <?php foreach ($ingresos as $row): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row['mensualidad'] == 'SI' && $row['activo'] == 'SI' && empty($row['fecha_retiro'])): ?>
                                                    <span class="badge bg-success">Activo</span>
                                                <?php elseif (!empty($row['fecha_retiro'])): ?>
                        ...
                        buttons: [
                            {
                                ...
                                title: 'Mensualidades_ingresadas_<?= $fecha_inicio ?>_<?= $fecha_fin ?>'
                            },
                            {
                                extend: 'pdfHtml5',
                                text: 'PDF',
                                className: 'btn btn-danger btn-sm',
                                title: 'Mensualidades ingresadas',
