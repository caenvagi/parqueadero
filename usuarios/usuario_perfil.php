<?php
    ...
    // CONSULTA USUARIOS EN TABLA USUARIOS 
        ...
        try {
            ...
            $stmt = $pdo->prepare("  SELECT id,nombre,avatar,activo,tipo_cargo,usuario,cargo_nombre,telefono,TP.tipo_usuario
                                                FROM usuarios as US
                                                INNER JOIN tipo_cargo as TC ON TC.id_cargo = US.tipo_cargo
                                                INNER JOIN tipo_usuarios as TP ON TP.id_tipo_usuario = US.tipo_usuario
                                                WHERE id=$usuario
                            ...
                            <div class="container col-12 col-sm-12 " id="containerPerfil">
                                <div class="row col-12 col-sm-12 ">
                                    ...
                                    <?php foreach ($usuarios_activos as $usuario): ?>
                                        <img class="fotoPerfil" src="<?= htmlspecialchars($usuario['avatar']) ?>"></img>                                          
                                    </div>

                                    <div class="card border-light col-sm-6 col-md-7" id="datosUser">
                                        <h4 id="datosNombre"><?= htmlspecialchars($usuario['nombre']) ?></h4>
                                        <p id="datosCargo" class="datosCargo m-0"><h4 id="datosNombre">
                                            <?= htmlspecialchars($usuario['cargo_nombre']) ?></h4>
                                        </p>
                                        <div class="row">
                                            ...
                                            <div class="card border-light col-7 col-sm-7 col-md-8" id="cardDatos">
                                                <h7 class="datosCards"><?= htmlspecialchars($usuario['telefono']) ?></h7>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-10">
                                            ...
                                            <div class="card border-light col-7 col-sm-7 col-md-8" id="cardDatos">
                                                <h7 class="datosCards"><?= htmlspecialchars($usuario['usuario']) ?></h7>
                                                <h7 class="datosCards"><?= htmlspecialchars($usuario['tipo_usuario']) ?></h7>
                                                <h7 class="datosCards"><?= htmlspecialchars($usuario['cargo_nombre']) ?></h7>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="" method="POST" name="frmChangePass" id="frmChangePass">
                                                        <div class="form-group m-2">
                                                            <div class="input-group mb-3 m-2 mt-3">
                                                                ...
                                                                <button class="btn btn-secondary" onclick="mostrarPassword1()" type="button" id="button-addon1"><span class="bi bi-eye-slash icon"></span></button>
                                                            </div>
                                                            <div class="input-group mb-3 m-2 mt-3">
                                                                <span class="input-group-text" id="basic-addon1"><i class='bi bi-key'></i>&nbsp;</span>
                                                                <input class="form-control" type="password" name="txtNewPassUser"  id="txtNewPassUser"  placeholder="Nueva Contraseña" required>
                                                                <button class="btn btn-secondary" onclick="mostrarPassword2()" type="button" id="button-addon2"><span class="bi bi-eye-slash icon"></span></button>
                                                            </div>
                                                            <div class="input-group mb-3 m-2 mt-3">
                                                                <span class="input-group-text" id="basic-addon1"><i class='bi bi-key'></i>&nbsp;</span>
                                                                <input class="form-control" type="password" name="txtPassConfirm"  id="txtPassConfirm"  placeholder="Confirmar Contraseña" required>
                                                                <button class="btn btn-secondary" onclick="mostrarPassword3()" type="button" id="button-addon3"><span class="bi bi-eye-slash icon"></span></button>
                                                            </div>
                                                        </div>
                                                            <style>
                                                                .alertChangePass{
